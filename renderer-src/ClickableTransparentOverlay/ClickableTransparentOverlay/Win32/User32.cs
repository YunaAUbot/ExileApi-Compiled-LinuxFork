namespace ClickableTransparentOverlay.Win32
{
    ...
    internal static class User32
    {
        ...
        {
            // Window styles are 32-bit values even in a 64-bit process. Wine
            // implements GetWindowLongW reliably, while some Proton builds do
            // not expose the GetWindowLongPtrW macro alias to P/Invoke.
        ...
        [DllImport(LibraryName, CharSet = CharSet.Unicode, EntryPoint = "FindWindowW")]
        public static extern IntPtr FindWindow(string className, string windowName);

        [DllImport(LibraryName, SetLastError = true, EntryPoint = "SetWindowLongPtrW")]
        public static extern IntPtr SetWindowOwner(IntPtr hwnd, int index, IntPtr owner);
    }
}
